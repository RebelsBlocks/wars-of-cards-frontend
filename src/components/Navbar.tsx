...
export default function Navbar() {
  ...
  const sidebarWidthClass = 'w-[200px]'; // Compact width for better space utilization
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 bottom-0 z-20 ${useMobileHeader ? 'w-[200px]' : sidebarWidthClass} bg-[rgba(0,0,0,0.95)] border-r border-[rgba(237,201,81,0.3)] backdrop-blur transition-all duration-300 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col`}
      >
